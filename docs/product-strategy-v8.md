...
- Team（¥99/月 起，按团队计费，非 seat）：扩展团队上限、团队级 agent coordinator 角色、团队分析看板
- MCP Developer Access（按调用量计费，P1 落地）：面向第三方 Agent 开发者按每千次 MCP 写调用计费，面向外部 SaaS 型 AI 工具而非个人
...
- MAU 3 万（DAU:MAU ~ 15%）
- Pro 转化率 3%（= 900 付费）
- Team 转化率：100 个活跃团队付费
- ARR 估算：`900 × ¥299 + 100 × ¥99 × 12 = ¥26.9 万 + ¥11.9 万 ≈ ¥38.8 万`
