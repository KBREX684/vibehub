...
| 编号 | 任务 | 优先级 | 难度 | 状态 |
|------|------|--------|------|------|
| C-1 | 社交互动基础（点赞 + 收藏 + 关注） | 🟠 P1 | M | 🔲 |
| C-2 | 嵌套评论（引用回复） | 🟠 P1 | M | 🔲 |
| C-3 | 通知系统扩展 | 🟠 P1 | S | 🔲 |
| C-4 | 个性化推荐 Feed | 🟠 P1 | M | 🔲 |
| C-5 | 项目画廊"每日展示位" | 🟠 P1 | S | 🔲 |
| C-6 | GitHub 仓库展示集成（轻量级） | 🟡 P2 | S | 🔲 |
| C-7 | 全文搜索升级 | 🟡 P2 | M | 🔲 |
...
| 编号 | 任务 | 优先级 | 难度 | 状态 |
|------|------|--------|------|------|
| T-1 | 外部聊天绑定（替代自建聊天） | 🟠 P1 | S | 🔲 |
| T-2 | 里程碑公开展示 | 🟠 P1 | S | 🔲 |
| T-3 | GitHub 仓库绑定（Team 级别） | 🟡 P2 | M | 🔲 |
| T-4 | 协作意向流程打通 | 🟡 P2 | M | 🔲 |
...
| 编号 | 任务 | 优先级 | 难度 | 状态 |
|------|------|--------|------|------|
| A-1 | MCP stdio 传输层 | 🟠 P1 | L | 🔲 |
| A-2 | MCP 工具扩展 | 🟡 P2 | S | 🔲 |
| A-3 | Agent 友好的结构化元数据 | 🟡 P2 | S | 🔲 |
...
| 编号 | 任务 | 优先级 | 难度 | 状态 |
|------|------|--------|------|------|
| M-1 | Free vs Pro 边界清晰化 | 🟠 P1 | S | 🔲 |
| M-2 | 支付网关（Stripe 优先） | 🟠 P1 | XL | 🔲 |
| M-3 | 价值触发型升级引导 | 🟡 P2 | S | 🔲 |
