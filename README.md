...
- `web/`: Next.js full-stack website (P1 MVP; **P2** slices P2-1…P2-5; **P3 officially closed** on 2026-04-13; **P4** open API: keys, scopes, rate limits, `/api/v1/public/*`, **`GET /api/v1/openapi.json`** — see `docs/01_实现计划图.md` (v2.6) and `docs/03_项目日志.md`)
