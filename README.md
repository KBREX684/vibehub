...
- `web/`: Next.js full-stack website (P1 MVP; **P2** slices P2-1…P2-5; **P3** Team, join requests, project↔team link, tasks, milestones, task sort — see `docs/01_实现计划图.md` and `docs/03_项目日志.md`)
