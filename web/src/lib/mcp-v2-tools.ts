...
export const MCP_V2_TOOL_SCOPES: Record<McpV2ToolName, ApiKeyScope> = {
  ...
  workspace_list_artifacts: "read:team:workspace",
  ...
  workspace_request_upload: "write:team:workspace",
  snapshot_create: "write:team:workspace",
  snapshot_rollback: "write:team:workspace",
};
...
export const MCP_V2_TOOL_DEFINITIONS: McpV2ToolDefinition[] = [
  ...
  },
  {
    ...
    description: "Submit a structured collaboration intent on a project (by project slug). Requires write:intents.",
    ...
    exampleInput: {
      projectSlug: "vibehub",
      intentType: "join",
      pitch: "I can own frontend implementation and QA for shipping-ready product surfaces.",
      whyYou: "This project already has a strong workspace-first direction and I can help execute it.",
      howCollab: "I can join as a contributor and work through the team workspace with structured handoff.",
    },
    inputSchema: {
      type: "object",
      required: ["projectSlug", "intentType", "pitch", "whyYou", "howCollab"],
      properties: {
        projectSlug: { type: "string" },
        intentType: { type: "string", enum: ["join", "recruit"] },
        pitch: { type: "string", minLength: 10, maxLength: 250 },
        whyYou: { type: "string", minLength: 10, maxLength: 250 },
        howCollab: { type: "string", minLength: 10, maxLength: 250 },
      },
    },
  },
  {
  ...
  },
  {
    ...
    description: "List files in a team workspace. Requires read:team:workspace.",
    requiredScope: MCP_V2_TOOL_SCOPES.workspace_list_artifacts,
    capabilityGroup: "teams",
    writeTool: false,
    exampleInput: { teamSlug: "vibehub-core" },
    inputSchema: {
  ...
  {
    name: "workspace_request_upload",
    description: "Request a confirmation-gated workspace file upload on behalf of an agent.",
    requiredScope: MCP_V2_TOOL_SCOPES.workspace_request_upload,
    capabilityGroup: "teams",
    writeTool: true,
    exampleInput: {
    ...
    inputSchema: {
      type: "object",
      required: ["teamSlug", "filename", "contentType", "sizeBytes"],
      properties: {
        teamSlug: { type: "string" },
  ...
  },
  {
    ...
    description: "Request a confirmation-gated snapshot creation for a team workspace.",
    requiredScope: MCP_V2_TOOL_SCOPES.snapshot_create,
    capabilityGroup: "teams",
    writeTool: true,
    exampleInput: {
      teamSlug: "vibehub-core",
      title: "Beta handoff snapshot",
      summary: "Checkpoint before delivery review",
      projectIds: ["proj_123"],
    },
    inputSchema: {
      type: "object",
      required: ["teamSlug", "title", "summary", "projectIds"],
      properties: {
        teamSlug: { type: "string" },
        title: { type: "string", minLength: 3, maxLength: 120 },
        summary: { type: "string", minLength: 3, maxLength: 500 },
        goal: { type: "string", maxLength: 500 },
        roleNotes: { type: "string", maxLength: 500 },
        projectIds: { type: "array", items: { type: "string" }, minItems: 1 },
      },
    },
  },
  {
    name: "snapshot_rollback",
    description: "Request a confirmation-gated rollback to an earlier team workspace snapshot.",
    requiredScope: MCP_V2_TOOL_SCOPES.snapshot_rollback,
    capabilityGroup: "teams",
    writeTool: true,
    exampleInput: { teamSlug: "vibehub-core", snapshotId: "snap_123" },
    inputSchema: {
      type: "object",
      required: ["teamSlug", "snapshotId"],
      properties: {
        teamSlug: { type: "string" },
